        ...
        <Card key={proj.id} className="mb-3">
          <Card.Body>
            ...
            <div className="mb-3 small text-muted">
              ...
              <div><strong>Assigned Role:</strong> {proj.assignedRole || "Not Set"}</div>

              {(proj.assignedTo || proj.assigned_to || []).length > 0 && (
                <div><strong>Team Members:</strong> {(proj.assignedTo || proj.assigned_to).join(", ")}</div>
              )}
